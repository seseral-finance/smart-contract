...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "SESERAL"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "SSL".
   */
...
contract Seseral is SSLToken {

  constructor() SSLToken("Seseral", "ssl", 8, 100000) public {}
